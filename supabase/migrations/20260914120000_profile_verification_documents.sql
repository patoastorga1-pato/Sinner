-- Profile verification documents and simplified identity.
-- Age verification uses a private Supabase Storage bucket. Public profile views never expose the document path.
