    ...
    <main>
      ...
      <section className="mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[minmax(0,1fr)_340px]">
          <div>
            <p className="text-xs font-semibold uppercase text-sinner-goldSoft">Booking review</p><h1 className="mt-3 font-display text-5xl text-sinner-ivory">Review your selection</h1><p className="mt-4 max-w-xl leading-7 text-sinner-mist">Review the details before continuing. Demo reservations do not charge a card.</p>
